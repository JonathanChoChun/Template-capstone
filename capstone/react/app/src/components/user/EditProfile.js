...
import MemeImage from "../webimage/MemeImage";
                ...
                {user !== undefined &&
                    <Form  className="form" onSubmit={handleUpdateDetail}>
                        <Form.Group className="mb-3" key="username">
                            ...
                            <Form.Control type="text" value={user?.userName} className="me-2" id="userName"/>
                        </Form.Group>
                        <Form.Group className="mb-3" key="firstName">
                            <Form.Label htmlFor="firstName">First Name</Form.Label>
                            <Form.Control type="text" value={user?.firstName} className="me-2" id="firstName"/>
                        </Form.Group>
                        <Form.Group className="mb-3" key="lastName">
                            <Form.Label htmlFor="lastName">Last Name</Form.Label>
                            <Form.Control type="text" value={user?.lastName} className="me-2" id="lastName"/>
                        </Form.Group>
                        {user?.profileImageId > 0 &&
                            <WebImage cssClass="profileEditPic" imageId={user?.profileImageId} altText={user?.userName}/>
                        }
                        {user?.profileImageId > 0 &&
                            <MemeImage cssClass="profileEditPic" imageId={user?.profileImageId} altText={user?.userName}/>
                        }
                        {user?.profileImageId === 0 &&
